package com.mercy.rtplibrary.base;
...
import com.mercy.encoder.input.video.GetCameraData;
import com.mercy.encoder.utils.CodecUtil;
import com.mercy.encoder.video.FormatVideoEncoder;
import com.mercy.encoder.video.GetVideoData;
import com.mercy.encoder.video.VideoEncoder;
import com.mercy.encoder.Frame;
import com.mercy.encoder.audio.AudioEncoder;
import com.mercy.encoder.audio.GetAacData;
import com.mercy.encoder.input.audio.GetMicrophoneData;
import com.mercy.encoder.input.audio.MicrophoneManager;
import com.mercy.encoder.input.video.Camera1ApiManager;
import com.mercy.encoder.input.video.CameraHelper;
import com.mercy.rtplibrary.util.FpsListener;
import com.mercy.rtplibrary.util.RecordController;
import com.mercy.rtplibrary.view.GlInterface;
import com.mercy.rtplibrary.view.LightOpenGlView;
import com.mercy.rtplibrary.view.OffScreenGlThread;
...
public abstract class Camera1Base
   ...
   *
   * @param cameraFacing front or back camera. Like: {@link CameraHelper.Facing#BACK}
   * {@link CameraHelper.Facing#FRONT}
