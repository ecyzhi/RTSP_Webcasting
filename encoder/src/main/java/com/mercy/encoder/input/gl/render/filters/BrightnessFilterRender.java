package com.mercy.encoder.input.gl.render.filters;
...
import com.mercy.encoder.input.gl.render.BaseRenderOffScreen;
...
public class BrightnessFilterRender extends BaseFilterRender {
  ...
  public BrightnessFilterRender() {
    squareVertex = ByteBuffer.allocateDirect(squareVertexDataFilter.length * BaseRenderOffScreen.FLOAT_SIZE_BYTES)
